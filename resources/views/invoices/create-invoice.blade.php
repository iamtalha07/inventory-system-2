                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <button title="Add New Booker" type="button" class="btn btn-primary"
                                                data-toggle="modal" data-target="#bookerModal">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                            <button title="Delete Role" type="button" class="btn btn-danger"
                                                data-toggle="modal" data-target="#bookerModalDelete">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" class="form-control productCategory" id="category"
                                            required>
                                    ...
                                    <tbody id="productRow">
                                        <tr class="row_id">
                                            <td style="width: 360px">
                                                <select name="product_id[]" id="product" class="form-control productname product">
                                            ...
                                            <td><input type="text" id="stockID" name="stock[]"
                                            ...
                                            <td><input type="text" name="disAmount[]" value="0.00"
                                                    class="form-control disAmount" readonly></td>
                                            <td style="display: none;"><input type="text" name="amount[]"
                                                    value="0.00" class="form-control amount" readonly></td>
                                            <td><button type="button" name="add" id="add"
                                                    class="btn btn-success addRow"><i class="fas fa-plus"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        ...
                                        <table class="table">
                                            <tr id="discountCash">
                                                ...
                                                <td><input type="text" class="form-control onlyDecimal"
                                                        name="lessTradeOffer" id="lessTradeOffer"></td>
                                            </tr>
                                            <tr id="discountPer">
                                                <th>Less % Discount:</th>
                                                <td><input type="text" class="form-control onlyDecimal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form id="addBookerForm" autocomplete="off">
                        ...
                        <div class="modal-footer justify-content-between">
                            <button type="button" id="cancelBookerDelete" class="btn btn-default"
                                data-dismiss="modal">Close</button>
                            <button type="button" id="deleteBooker" class="btn btn-primary" disabled>Delete
                                Booker(s)</button>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('.addRow').on('click', function() {
                addRow();
                addProductByCategoryInLatestRow();
            });

            function addProductByCategoryInLatestRow() {
              ...
              if (categoryId) {
                  $.ajax({
                      ...
                      success: function(data) {
                          if (data) {
                              $.each(data, function(key, category) {
                                  $('#table_id tr:nth-last-child(1) td select').append('<option value="' + category.id + '">' + category.name + '</option>');
                              });
                          }
                      }
                  });
            ...
            function addRow() {
                var addRow = '<tr id="row_id">\n' +
                    '<td><select name="product_id[]" class="form-control productname product" id = "dropdown_id" required>\n' +
                    '<option value="" selected="true" disabled="true">Select Product</option>\n' +
                    '</select></td>\n' +
                    '<td><input type="text" name="ctnQty[]" class="form-control ctnQty"></td>\n' +
                    '<td><input type="text" name="qty[]" class="form-control qty"></td>\n' +
